...
class RulesVC: UIViewController {
    ...
    func titleConfigure() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30) // training uses negative numbers
            // as well bottom constraints
        ])
    }
